...
class Scorer {
  constructor(strategy, params) {
    this.model = null;
    switch (strategy) {
      case SCORING_STRATEGY.exact:
        this.model = new ExactModel();
        break;
      case SCORING_STRATEGY.dice:
        this.model = new DiceModel();
        break;
      case SCORING_STRATEGY.ultron:
        this.model = new UltronModel(params);
        break;
      default:
        throw new Error("Invalid scoring strategy specified " + strategy);
    }
  }
